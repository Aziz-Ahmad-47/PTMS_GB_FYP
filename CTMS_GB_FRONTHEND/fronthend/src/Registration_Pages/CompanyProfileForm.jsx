...
import { 
  ...
  Mountain, Route, Calendar, Clock, Users as UsersIcon, Award, Car as CarIcon
} from "lucide-react";
...
// Updated Step tracker component - Sticky but with limited position
const StepIndicator = ({ currentStep, scrollToSection }) => {
  const steps = [
  ...
  return (
    <div className="sticky top-0 z-30 bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-100">
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="text-gray-600 text-center max-w-2xl">
          Complete all 6 steps to register your company. You can save as draft and return anytime.
        </p>
      </div>
      ...
      <div className="hidden md:block">
        <div className="relative">
          ...
          <div 
            className="absolute top-5 left-0 h-1 bg-gradient-to-r from-indigo-500 to-purple-500 z-10 transition-all duration-500"
        ...
        <div className="flex items-center justify-between bg-gray-50 p-4 rounded-xl">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">{steps[currentStep - 1]?.label}</p>
            </div>
          </div>
...
// Updated Banner Component for left side with columns for "Why Register With Us"
const RegistrationBanner = () => {
  const features = [
    { icon: <Shield className="h-5 w-5" />, text: "Secure & Verified Registration" },
    { icon: <Route className="h-5 w-5" />, text: "Multiple Route Management" },
    { icon: <CarIcon className="h-5 w-5" />, text: "Vehicle Fleet Tracking" },
    { icon: <UsersIcon className="h-5 w-5" />, text: "Driver Management" },
    { icon: <Clock className="h-5 w-5" />, text: "24/7 Support Available" },
    { icon: <Award className="h-5 w-5" />, text: "Official Recognition" },
  ];

  return (
    <div className="h-full bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 rounded-3xl shadow-2xl overflow-hidden relative">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-10 left-10 w-64 h-64 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 right-10 w-80 h-80 bg-gradient-to-r from-indigo-500 to-blue-500 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 h-full p-8 flex flex-col">
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 p-3 shadow-2xl">
            <Mountain className="h-10 w-10 text-white" />
          </div>
          <div>
            <h1 className="text-3xl font-bold text-white">PTMS GB</h1>
            <p className="text-blue-200 text-lg">Passenger Transport Management System</p>
            <p className="text-blue-300 text-sm">Gilgit-Baltistan</p>
          </div>
        </div>
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-bold text-white mb-4">
            Welcome to PTMS GB Company Registration
          </h2>
          <p className="text-blue-100 leading-relaxed">
            Join Pakistan's premier transport management system. Register your company 
            to access thousands of passengers, streamline operations, and grow your business 
            with our secure platform.
          </p>
        </div>

        {/* Features - Updated to 2 columns */}
        <div className="mb-12">
          <h3 className="text-xl font-bold text-white mb-6">Why Register With Us?</h3>
        ...
        {/* Stats */}
           {/* Stats - Updated to 2 columns instead of 4 */}
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="text-center p-5 bg-white/10 rounded-xl backdrop-blur-sm">
            <div className="text-3xl font-bold text-white">500+</div>
            <div className="text-blue-200 text-sm mt-2">Companies</div>
          </div>
          <div className="text-center p-5 bg-white/10 rounded-xl backdrop-blur-sm">
            <div className="text-3xl font-bold text-white">50K+</div>
            <div className="text-blue-200 text-sm mt-2">Passengers</div>
          </div>
          <div className="text-center p-5 bg-white/10 rounded-xl backdrop-blur-sm">
            <div className="text-3xl font-bold text-white">1K+</div>
            <div className="text-blue-200 text-sm mt-2">Routes</div>
          </div>
          <div className="text-center p-5 bg-white/10 rounded-xl backdrop-blur-sm">
        ...
        <div className="mt-auto bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
          <h3 className="text-lg font-bold text-white mb-4">Registration Process</h3>
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center">
                <span className="text-white text-xs font-bold">1</span>
              </div>
              <span className="text-blue-100 text-sm">Company & Owner Information</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center">
                <span className="text-white text-xs font-bold">2</span>
              </div>
              <span className="text-blue-100 text-sm">Add Routes & Vehicles</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center">
                <span className="text-white text-xs font-bold">3</span>
              </div>
              <span className="text-blue-100 text-sm">Add Drivers & Documents</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center">
                <span className="text-white text-xs font-bold">4</span>
              </div>
              <span className="text-blue-100 text-sm">Submit for Review</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-blue-300 text-sm italic">
            "Connecting Gilgit-Baltistan through reliable transport solutions"
          </p>
        </div>
      </div>
    </div>
...
export default function CompanyProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      {/* Main Content with Side Banner */}
      <div className={`max-w-7xl mx-auto px-4 py-8 ${showConfirm ? 'opacity-30 pointer-events-none' : ''}`}>
        {/* Step Indicator - Now sticky but with limited movement */}
        <div className="relative">
          <StepIndicator currentStep={currentStep} scrollToSection={scrollToSection} />
        </div>
